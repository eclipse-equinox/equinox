...
/**
 * This class performs the processing of the telnet commands, and updates
 * respectively what is displayed in the output. Also, it performs terminal type
 * negotiation with the telnet client. This is important for some of the escape
 * sequences, which are different for the different terminal types. Without such
 * negotiation, some keys (such as backspace, del, insert, home, etc.) may not
 * be correctly interpreted by the telnet server. Currently the supported
 * terminal types are ANSI, VT100, VT220, VT320, XTERM and SCO. The support is
 * limited to the following keys - BACKSPACE, DEL, INSERT, HOME, END, PAGEUP,
 * PAGEDOWN, ARROWS.
 */

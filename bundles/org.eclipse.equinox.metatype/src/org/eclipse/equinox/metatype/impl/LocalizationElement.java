...
public abstract class LocalizationElement {
	...
	/*
	 * This method must be (and currently is) called after
	 * setLocaleAndBundle(String, Bundle). If the bundle is not set, an NPE will be
	 * generated by getResourceBundle(String, String, Bundle).
	 */
	...
	/*
	 * This method must be (and currently is) called before getResourceBundle(). If
	 * the bundle is not set, an NPE will be generated by getResourceBundle(String,
	 * String, Bundle).
	 */
	protected synchronized void setLocaleAndBundle(String locale, Bundle bundle,
			Map<String, ResourceBundle> resourceBundleCache) {
		this.locale = locale;
		this.bundle = bundle;

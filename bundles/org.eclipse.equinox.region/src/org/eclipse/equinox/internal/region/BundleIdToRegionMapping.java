...
public interface BundleIdToRegionMapping {
	...
	/**
	 * Associates the given bundle id with the given region. If the bundle id is
	 * already associated with a different region, throws {@link BundleException}.
	 ...
	 *                 associated
	 * @throws BundleException if the bundle id is already associated with a
	 *                         different region
	 */

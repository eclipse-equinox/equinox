...
final public class SecurePreferencesFactory {
	 ...
	 * <p>
	 * The framework will attempt to open secure preferences in a user-specific
	 * location. As a result, the information stored can be shared among all
	 * programs run by the user. The location is determined as follows:
	 * </p>
	 * <ol>
	 * <li>&quot;-equinox.keyring&quot; command line arguments</li>
	 * <li>Java's &quot;user.home&quot; environment variable. On Windows system it
	 * usually corresponds to the %USERPROFILE% environment variable or determined
	 * as the parent of user's desktop folder. On Unix Java usually determines it
	 * from user's entry in the password file (commonly this corresponds to $HOME
	...
	/**
	 * Returns a secure properties corresponding to the URL locations supplied. If
	 * URL is <code>null</code>, a default location is used.
	 * <p>
	 * Note that while this method accepts URLs to account for future expandability
	 * of this API, at present the method only accepts &quot;file&quot; URLs that
	 * point to a directory. An {@link IOException} might be thrown if unsupported
	 * URL is passed to this method.
	 * </p>
	 * <p>
	 ...
	 *                 default location
	 * @param options  use to pass hints to the secure preferences implementation.
	 *                 Pass <code>null</code> if no options are needed. See
	 *                 {@link IProviderHints}
	 * @return a secure preferences
	 * @throws IOException if unsupported URLs types are passed in, or if location
	 *                     is not accessible
	 */

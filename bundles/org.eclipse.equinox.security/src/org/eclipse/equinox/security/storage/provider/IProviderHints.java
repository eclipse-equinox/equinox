 ...
 * </p>
 * <p>
 * Password provider modules are advised to take into consideration those
 * options when applicable; note, however, that it is up to specific module to
 * decide if (and how) they would respond to an option.
 * </p>
 * <p>
 * The set of options is open-ended and not limited to options specified below;
 * modules can choose to process additional hints.
 * </p>
 * <p>

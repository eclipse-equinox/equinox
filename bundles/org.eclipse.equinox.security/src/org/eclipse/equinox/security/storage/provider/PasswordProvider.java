...
/**
 * Password provider modules should extend this class. Secure storage will ask
 * modules for passwords used to encrypt entries stored in the secure
 * preferences.
 * <p>
 * Password provider modules can be thought of as trusted 3rd parties used to
 * provide passwords to open keyrings containing secure preferences. They can do
 * it, for instance, by asking the user to enter password, or integrating with
 * operating system login, or exchanging information with a device such as a
 * smart card reader.
 * </p>
 * <p>
...
public abstract class PasswordProvider {
	 ...
	 * set to <code>1</code>, it indicates that a new password should be created;
	 ...
	 *                     {@link #PASSWORD_CHANGE}. When evaluating value of this
	 *                     field use bit-wise filters as additional bits might be
	 ...
	 *         <code>false</code> otherwise. If in doubt, return <code>false</code>
	 */

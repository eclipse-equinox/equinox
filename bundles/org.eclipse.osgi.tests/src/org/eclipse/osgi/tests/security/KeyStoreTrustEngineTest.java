...
public class KeyStoreTrustEngineTest extends TestCase {
	...
	public void testFindTrustAnchor6() {
		try {
			// TODO is an exception expected here??
			engine.findTrustAnchor(getTestCertificateChain(new String[] {"ca2_leafa", "ca1_root"})); //$NON-NLS-1$ //$NON-NLS-2$
			assertTrue("Did not throw CertificateException on invalid certificate chain", true); //$NON-NLS-1$
		} catch (Throwable t) {
			assertTrue("Incorrect exception thrown on invalid certificate chain", t instanceof CertificateException); //$NON-NLS-1$
		}
	}
	...
	public void testFindTrustAnchor7() {
		try {
			// TODO is an exception expected here??
			engine.findTrustAnchor(getTestCertificateChain(new String[] {"ca1_leafb", "ca1_root"})); //$NON-NLS-1$ //$NON-NLS-2$
			assertTrue("Did not throw CertificateException on incomplete certificate chain", true); //$NON-NLS-1$
		} catch (Throwable t) {
			assertTrue("Incorrect exception thrown on incomplete certificate chain", t instanceof CertificateException); //$NON-NLS-1$
		}
	}
	...
	public void testAddTrustAnchor3() {
		try {
			// TODO are we expecting an exception here?
			engine.addTrustAnchor(getTestCertificate("ca1_root"), "new_root"); //$NON-NLS-1$ //$NON-NLS-2$
			assertTrue("Did not throw IllegalArgumentException on duplicate cert", true); //$NON-NLS-1$
		} catch (Throwable t) {
	...
	public void testAddTrustAnchor4() {
		try {
			// TODO are we expecting an exception here?
			engine.addTrustAnchor(getTestCertificate("ca1_root"), "ca1_root"); //$NON-NLS-1$ //$NON-NLS-2$
			assertTrue("Did not throw IllegalArgumentException on duplicate alias", true); //$NON-NLS-1$
		} catch (Throwable t) {
	...
	public void testRemoveTrustAnchor3() {
		try {
			// TODO are we expecting an exception here?
			engine.removeTrustAnchor("ca1_root"); //$NON-NLS-1$
			assertTrue("Did not throw CertificateException on alias not found", true); //$NON-NLS-1$
		} catch (Throwable t) {
	...
	public void testGetTrustAnchor2() {
		try {
			// TODO are we expecting an exception here?
			engine.getTrustAnchor("ca1_root"); //$NON-NLS-1$
			assertTrue("Did not throw CertificateException on get by unknown alias", true); //$NON-NLS-1$
		} catch (Throwable t) {
			assertTrue("Incorrect exception thrown on remove by unknown alias", t instanceof CertificateException); //$NON-NLS-1$
		}
	}

...
public interface BundleDescription extends BaseDescription, BundleRevision {
	...
	/**
	 * Returns an array of export package descriptions defined by the Export-Package
	 * clauses. All export package descriptions are returned even if they have not
	 * been selected by the resolver as an exporter of the package.
	 *
	...
	/**
	 * Returns all the capabilities provided by ths bundle that have been selected
	...
	/**
	 * Returns the state object which hosts this bundle. null is returned if this
	 * bundle is not currently in a state.
	 *
	...
	/**
	 * Returns the host for this bundle. null is returned if this bundle is not a
	 * fragment.
	 *
	...
	/**
	 * Returns the numeric id of this bundle. Typically a bundle description will
	 * only have a numeric id if it represents a bundle that is installed in a
	 * framework as the framework assigns the ids. -1 is returned if the id is not
	 * known.
	 *
	 ...
	 * most one single version of the bundle can be resolved at a time.
	 * <p>
	 * The existence of a single bundle marked as singleton causes all bundles with
	 * the same symbolic name to be treated as singletons as well.
	 * </p>
	 *
	 * @return <code>true</code>, if this bundle is a singleton, <code>false</code>
	 *         otherwise
	 */
	...
	/**
	 * Returns the export packages that satisfy imported packages for this bundle

...
public interface GenericSpecification extends VersionConstraint {
	...
	/**
	 * Returns the resolution type of the required capability. The returned value is
	 * a bit mask that may have the optional bit {@link #RESOLUTION_OPTIONAL} and/or
	 * the multiple bit {@link #RESOLUTION_MULTIPLE} set.
	 *
	...
	/**
	 * Returns the suppliers of the capability. If the the resolution is multiple
	 * then more than one supplier may be returned
	 * 

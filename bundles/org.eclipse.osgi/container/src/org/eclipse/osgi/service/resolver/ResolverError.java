...
public interface ResolverError {
	/**
	 * Error type constant (bit mask) indicating that an Import-Package could not be
	 * resolved.
	 * 
	...
	/**
	 * Error type constant (bit mask) indicating that a Require-Bundle could not be
	 * resolved.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that a Fragment-Host could not be
	 * resolved.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that the bundle could not be
	 * resolved because another singleton bundle was selected.
	 * 
	 * @see ResolverError#getType()
	 */
	public static final int SINGLETON_SELECTION = 0x0008;
	/**
	 * Error type constant (bit mask) indicating that the bundle fragment could not
	 * be resolved because a constraint conflict with a host.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that an Import-Package could not be
	 * resolved because of a uses directive conflict.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that an Import-Package could not be
	 * resolved because the importing bundle does not have the correct permissions
	...
	/**
	 * Error type constant (bit mask) indicating that an Import-Package could not be
	 * resolved because no exporting bundle has the correct permissions to export
	 * the package.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that a Require-Bundle could not be
	 * resolved because the requiring bundle does not have the correct permissions
	...
	/**
	 * Error type constant (bit mask) indicating that a Require-Bundle could not be
	 * resolved because no bundle with the required symbolic name has the correct
	 * permissions to provide the required symbolic name.
	 * 
	 * @see ResolverError#getType()
	 */
	 ...
	 * Error type constant (bit mask) indicating that a Fragment-Host could not be
	 * resolved because no bundle with the required symbolic name has the correct
	 * permissions to host a fragment.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that a Fragment-Host could not be
	 * resolved because the fragment bundle does not have the correct permissions to
	 * be a fragment.
	 * 
	 * @see ResolverError#getType()
	 */
	 ...
	 * because a platform filter did not match the runtime environment.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that a bundle could not be resolved
	 * because the required execution enviroment did not match the runtime
	 * environment.
	 * 
	 * @see ResolverError#getType()
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that a bundle could not be resolved
	 * because the matching native code paths are invalid.
	 * 
	 * @since 3.4
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that a bundle could not be resolved
	 * because the bundle was disabled
	 * 
	 * @since 3.4
	 */
	...
	/**
	 * Error type constant (bit mask) indicating that a Require-Capability could not
	 * be resolved because the requiring bundle does not have the correct
	...
	/**
	 * Returns non-translatable data associated with this ResolverError. For
	 * example, the data for a ResolverError of type MISSING_IMPORT_PACKAGE could be
	 * the Import-Package manifest statement which did not resolve.
	 * 
	 ...
	 * an unsatisfied constraint; otherwise <code>null</code> is returned.
	 * 

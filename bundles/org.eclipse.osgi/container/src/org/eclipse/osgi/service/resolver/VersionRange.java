...
public class VersionRange extends org.osgi.framework.VersionRange {
	...
	/**
	 * An empty version range: "0.0.0". The empty version range includes all valid
	 * versions (any version greater than or equal to the version 0.0.0).
	 */
	 ...
	 *                   new Version(Integer.MAX_VALUE, Integer.MAX_VALUE,
	 *                   Integer.MAX_VALUE) is used.
	 */
	public VersionRange(Version minVersion, boolean includeMin, Version maxVersion, boolean includeMax) {
		super(includeMin ? INCLUDE_MIN : EXCLUDE_MIN, minVersion == null ? Version.emptyVersion : minVersion,
				versionMax.equals(maxVersion) ? null : maxVersion, includeMax ? INCLUDE_MAX : EXCLUDE_MAX);
	}
	 ...
	 * </pre>
	 *
	 * @param versionRange string representation of the version range or
	 *                     <code>null</code> for the empty range "0.0.0"
	...
	/**
	 * Returns whether the given version is included in this VersionRange. This will
	 * depend on the minimum and maximum versions of this VersionRange and the given
	 * version.
	 *
	 * @param version a version to be tested for inclusion in this VersionRange. If
	 *                <code>null</code> then {@link Version#emptyVersion} is used.
	 * @return <code>true</code> if the version is included, <code>false</code>
	 *         otherwise
	 */

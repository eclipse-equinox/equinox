...
public interface StateHelper {
	...
	/**
	 * Returns all unsatisfied constraints in the given state that have no possible supplier. 
	 * Returns an empty array if no unsatisfied constraints can be found.
	 * <p>
	 ...
	 * be additional unsatisfied constraints in the given state but these will have at 

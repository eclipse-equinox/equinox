...
public class PluginConverter implements IPluginConverter {
	...
	private final static String PI_RUNTIME = "org.eclipse.core.runtime"; //$NON-NLS-1$

	PluginConverter(BundleContext context) {
		this.context = context;
		devPathSpec = System.getProperty("osgi.dev");
		instance = this;
	}
	
	public static IPluginConverter getDefault() {
		return instance;
	}

//	public void convertManifest(IPluginInfo pluginInfo, File pluginLocation, File bundleManifestLocation) {
//		this.pluginInfo = pluginInfo;
//		this.pluginManifestLocation = pluginLocation;

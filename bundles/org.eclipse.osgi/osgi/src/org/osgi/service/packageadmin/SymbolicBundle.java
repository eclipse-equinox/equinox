...
/**
 * A provided SymbolicBundle.  
 * 
 * Instances implementing this interface are created by the Package 
 * Admin service.
 * 
 * <p>The information about a <tt>SymbolicBundle</tt> provided by this object is 
 * valid only until the next time <tt>PackageAdmin.refreshPackages()</tt> called.   
 * If a <tt>SymbolicBundle</tt> object becomes stale (that is, the bundle it 
...
public interface SymbolicBundle {
     ...
     * <tt>SymbolicBundle</tt> object.
     *
     * @return The providing bundle, or <tt>null</tt> if this <tt>SymbolicBundle</tt>
     ...
     * associated with this <tt>SymbolicBundle</tt> object.
     *
     ...
     * <tt>SymbolicBundle</tt> object has become stale.
     */
     ...
     * <tt>SymbolicBundle</tt> object.
     *
     * @return The symbolic name of this <tt>SymbolicBundle</tt> object.
     */
	public String getName();

    /**
     * Returns the bundle version of this <tt>SymbolicBundle</tt>, as
     * specified in the providing bundle's manifest file.
     *
     * @return The bundle version of this <tt>SymbolicBundle</tt> object, or
     *         "0.0.0" if no bundle version information is available.
     */
	public String getVersion();

    /**
     * Returns <tt>true</tt> if the bundle associated with this <tt>SymbolicBundle</tt>
     ...
     * <tt>SymbolicBundle</tt> object has become stale; <tt>false</tt> otherwise.
     */

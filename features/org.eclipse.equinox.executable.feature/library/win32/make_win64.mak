...
cflags = -Ox -DNDEBUG \
	/Wall \
	-DUNICODE \
	-DCOBJMACROS /c -DUSE_ASSEMBLER -GS \
	/guard:cf \
	-DWIN64 -D_WIN64 \
	-D_MT -MT \
	$(CFLAGS)
...
L_FLAGS = /DYNAMICBASE /NXCOMPAT /HIGHENTROPYVA /guard:cf /NODEFAULTLIB /INCREMENTAL:NO /RELEASE /NOLOGO
RES     = $(PROGRAM_NAME).res
EXEC    = $(PROGRAM_OUTPUT)
CONSOLE = $(PROGRAM_NAME)c.exe
DLL    = $(PROGRAM_LIBRARY)
wcflags = -DDEFAULT_OS="\"$(DEFAULT_OS)\"" \
...
eclipseMain.obj: ../eclipseUnicode.h ../eclipseCommon.h ../eclipseMain.c 
	cl $(wcflags) /Fo$*.obj ../eclipseMain.c

eclipseMainConsole.obj: ../eclipseUnicode.h ../eclipseCommon.h ../eclipseMain.c 
	cl $(wcflags) -D_WIN32_CONSOLE /Fo$*.obj ../eclipseMain.c

eclipseCommon.obj: ../eclipseCommon.h ../eclipseUnicode.h ../eclipseCommon.c
	cl $(wcflags) /Fo$*.obj ../eclipseCommon.c

eclipse.obj: ../eclipseOS.h ../eclipseUnicode.h ../eclipse.c
	cl $(wcflags) /Fo$*.obj ../eclipse.c

eclipseUtil.obj: ../eclipseUtil.h ../eclipseUnicode.h ../eclipseUtil.c
	cl $(wcflags) /Fo$*.obj ../eclipseUtil.c

eclipseConfig.obj: ../eclipseConfig.h ../eclipseUnicode.h ../eclipseConfig.c
	cl $(wcflags) /Fo$*.obj ../eclipseConfig.c

eclipseWin.obj: ../eclipseOS.h ../eclipseUnicode.h eclipseWin.c
	cl $(wcflags) /Fo$*.obj eclipseWin.c

eclipseWinCommon.obj: ../eclipseCommon.h eclipseWinCommon.c
	cl $(wcflags) /Fo$*.obj eclipseWinCommon.c

eclipseJNI.obj: ../eclipseCommon.h ../eclipseOS.h ../eclipseJNI.c
	cl $(wcflags) /Fo$*.obj ../eclipseJNI.c

eclipseShm.obj: ../eclipseShm.h ../eclipseUnicode.h ../eclipseShm.c
	cl $(wcflags) /Fo$*.obj ../eclipseShm.c

$(EXEC): $(MAIN_OBJS) $(COMMON_OBJS) $(RES)
	link $(L_FLAGS) -subsystem:windows -entry:wmainCRTStartup \
		-out:$(PROGRAM_OUTPUT) $(MAIN_OBJS) $(COMMON_OBJS) $(RES) $(LIBS)

$(CONSOLE): $(MAIN_CONSOLE_OBJS) $(COMMON_OBJS)
	link $(L_FLAGS) -subsystem:console -entry:wmainCRTStartup \
		-out:$(CONSOLE) $(MAIN_CONSOLE_OBJS) $(COMMON_OBJS) $(LIBS)

$(DLL): $(DLL_OBJS) $(COMMON_OBJS)
	link $(L_FLAGS) /PDB:NONE -dll /BASE:0x140000000 /DLL \
		-out:$(PROGRAM_LIBRARY) $(DLL_OBJS) $(COMMON_OBJS) $(DLL_LIBS)
